...
Issue text: `ISSUE.md`.
## Work in progress: engine hang with speculative decoding (branch `engine-hang`)

A second, different anomaly on the fixed 2026-09-03 recipe with `dspark` speculative decoding
