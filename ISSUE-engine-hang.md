...
Status: **reproduced twice** with a stdlib script — once in 6 requests on a fresh server, once
in one loop of a full-run replay on a server that had served 1 000+ requests for 4 hours.
...
Client-side timelines: `results/2026-09-05-dspark-engine-hang/`.
